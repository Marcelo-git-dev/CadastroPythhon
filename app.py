...
class App(ctk.CTk):
    ...
    def appearence(self):
        ...
        self.opt_apm = ctk.CTkOptionMenu(self, values=['Dark', 'Ligth', "System"], command=self.change_apm).place(x=50, y=460)
    ...
    def todo_sistema(self):
        ...
        title = ctk.CTkLabel(frame, text="Cadastro de Cliente", font=("Century Gothic bold", 24), text_color="#fff", bg_color='transparent').place(x=243, y=10)
        
        span = ctk.CTkLabel(self, text="Por favor, preencha todos os campos do fomrulário!", font=("Century Gothic bold", 16), text_color=["#000", "#fff"]).place(x=50, y=70)
        ...
        lb_geneder = ctk.CTkLabel(self, text="Gênero:", font=("Century Gothic bold", 16), text_color=["#000", "#fff"])
        ...
        btn_submit = ctk.CTkButton(self, text="Salvar".upper(), command=submit, fg_color="#151", hover_color="#131", width=50).place(x=590, y=460)
        btn_clear = ctk.CTkButton(self, text="Limpar formulario".upper(), command=clear, fg_color="#555", hover_color="#333").place(x=440, y=460)
